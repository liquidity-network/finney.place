...
exports.postAPIPixel = (req, res, next) => {
    ...
    function paintWithUser(user) {
        ...
        if (!req.place.colours.includes(req.body.hex.toUpperCase())) return res.status(400).json({ success: false, error: { message: "You can't place that colour.", code: "disallowed_colour" } });
